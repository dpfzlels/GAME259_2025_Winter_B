	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_BTeamProjectTilde()
	{
		if (!Z_Registration_Info_UPackage__Script_BTeamProjectTilde.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_BTeamProjectTilde_OnPuzzleFinished__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_BTeamProjectTilde_RestartLevel__DelegateSignature,
			};
